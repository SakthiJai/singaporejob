...
<div class="row">
  <div class="col-sm-12">
   ...
   <div class="card-header d-flex justify-content-between">
     ...
     <?php if(isset($permission[2]) && $permission[2]->add==1){ ?>
        <button class="btn btn-success  range" onclick="addPet()" style="margin-top:6px;float:right; background-color: #32BDEA; border-color: #32BDEA; ">Add Items</button>
	<?php } ?>	
    ...
    <div class="modal-body">
      <form  id="deleteForm" method="post">
			...
			<h5>Are you sure want to delete?</h5>
              <button type="button" id="delete" onclick="deleteitems()" class="btn btn-primary btn-md">Yes</button>
...
<script src="https://cdn.datatables.net/colreorder/1.5.4/js/dataTables.colReorder.min.js" defer></script>
   ...
   {!! Html::script('/assets/application/items.js') !!}

<script>
    var baseUrl= '<?php echo URL::to('/'); ?>';
    console.log(baseUrl);
var editPermission	 = '<?php echo $permission[2]->update;?>';
var deletePermission = '<?php echo $permission[2]->delete;?>';
</script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="float: left;">Add Items</h4>
				<button type="button" class="close"  onclick="closeform()" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body form">
                <form  id="itemsForm" class="form-horizontal">
                    <input type="hidden" value="" id="id" name="id"/> 
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3"></label>
                            <div class="col-md-12">
                                <input name="items" id="items" placeholder="Enter items" onkeypress="return lettersOnly(event)" class="form-control" type="text" autocomplete="off" maxlength="50">
