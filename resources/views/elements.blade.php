    ...
    <div class="modal-body">
      <form  id="deleteForm" method="post">
			...
			<h5>Are you sure want to delete?</h5>
               <button type="button" id="delete" onclick="deleteelements()" class="btn btn-primary btn-md">Yes</button>
...
<script src="https://cdn.datatables.net/colreorder/1.5.4/js/dataTables.colReorder.min.js" defer></script>
   ...
   {!! Html::script('/assets/application/elements.js') !!}

<script>
    var baseUrl= '<?php echo URL::to('/'); ?>';
    console.log(baseUrl);
var editPermission	 = '<?php echo $permission[5]->update;?>';
var deletePermission = '<?php echo $permission[5]->delete;?>';	
</script>
...
<div class="modal fade" id="modal_form" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
			<h4 class="modal-title" style="float: left;">Add Elements</h4>
            ...
            <div class="modal-body form">
                <form  id="elementsForm" class="form-horizontal">
                    <input type="hidden" value="" id="id" name="id"/> 
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3"></label>
                            <div class="col-md-12">
                                <input name="elements_name" id="elements_name" maxlength="50" onkeypress="return lettersOnly(event)" placeholder="Enter elements" class="form-control" type="text" autocomplete="off">
