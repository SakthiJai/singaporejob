    ...
    <div class="modal-dialog modal-confirm">
		...
		<input type="hidden" id="delete_id" name="delete_id">
            ...
            <div class="modal-footer justify-content-center" style="margin-left: 45%;">
                ...
                <button type="button" id="submit" onclick="deletejobtype()" class="btn btn-primary btn-md" style="color: #fff;background-color: #844fc1;border-color: #844fc1;min-width: 62px;">Ok</button>
            </div>
        </div>
		</form>
    </div>
